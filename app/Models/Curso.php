...
class Curso extends Model
{
    ...
    public function gestiones() // CU25:OPERACION: Relacion entre el curso y las gestiones escolares en las que participa.
    {
    ...
    public function materias() // CU25:OPERACION: Relacion entre el curso y las materias asignadas por gestion y docente.
    {
    ...
    public function paralelos() // CU25:OPERACION: Relacion entre el curso y los paralelos disponibles segun asignaciones de materia.
    {
    ...
    public function nivel() //C CU25:OPERACION: Relacion entre el curso y el nivel academico al que pertenece.
    {
        return $this->belongsTo(Nivel::class, 'id_nivel');
    }

    // CU12: Paralelo principal relacionado al curso.
    public function paralelo() // CU25:OPERACION: Relacion entre el curso y el paralelo principal relacionado al curso.
    {
        return $this->belongsTo(Paralelo::class, 'id_paralelo', 'id_paralelo');
    }

    // CU12: Turno o jornada asociada al curso.
    public function turno() // CU25:OPERACION: Relacion entre el curso y el turno o jornada asociada al curso.
    {
